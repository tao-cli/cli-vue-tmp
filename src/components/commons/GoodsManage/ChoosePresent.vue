...
export default {
  ...
  data(){
    return {
      columns: [
        {
          ...
          render: (h, params) => {
            let curId = this.curPresent?this.curPresent['id']||this.curPresent['presentIdentify']:'';
            ...
            return h(
              ...
              [
                h(
                  "span",
                  {},
                  this.$format(params.row.createTime * 1, "YY-MM-DD HH:mm:ss")
                ),
                h(
                  "span",
                  {},
      ...
      presentList:[],total:0,loading:false,
  ...
  computed:{
    actColumns(){
      let nowCols = this.columns.slice(),arr=[];
