...
<template>
  <div >
    <slot name="cond-tool" ></slot>
    <slot name="cond-tabs" ></slot>
    <div style="margin-top:24px;">
      <Table :columns="columns" :data="tabData" :loading="loading"  @on-selection-change="selection=>$emit('selectionChange',selection)"></Table>      
    </div>
  </div>
</template>
<script>
