                    ...
                    h('Poptip',{
                        ...
                        [
                            h("Icon", {
                                props: {
                                    type: "ios-funnel",
                                    color: this.levelFilterFlag ? '#FF8C08' : ''
                                }
                            }),
                            h('div',{
                                slot: 'content'
                                ...
                                h(FilterTableColList, {
                                    ...
                                    on: {
                                        select: item => {
                                            ...
                                            this.searchData = Object.assign(this.searchData, {levelChangeType: level})
                                            this.$nextTick(() => {
                    ...
                    h('Poptip',{
                        ...
                        [
                            h("Icon", {
                                props: {
                                    type: "ios-funnel",
                                    color: this.changeReasonFlag ? '#FF8C08' : ''
                                }
                            }),
                            h('div',{
                                slot: 'content'
                                ...
                                h(FilterTableColList, {
                                    ...
                                    on: {
                                        select: item => {
                                            ...
                                            this.pageData.page = 1;
                                            this.searchData = Object.assign(this.searchData, {levelChangeReasons: levelChangeReasons})
                                            this.$nextTick(() => {
                                                this.getIdentityList()
                                            })
                                        }
