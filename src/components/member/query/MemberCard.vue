<template>
        ...
        <div class="member-card" :class="cardStyle">
            <div class="photo-name" >
                <div class="frozen-container">
                    <div class="frozen-tag" v-if="frozenStatus">冻结</div>
                </div>
                ...
                <div class="name-container">
                    <div class="title-container">
                        ...
                        <img class="user-gender"
                             v-if="memberInfo.sex !== 'N'" :src="showGender()" alt="用户性别"/>
                    </div>
                    <div class="card-desc">{{ memberInfo.phone }}</div>
                </div>
                <Checkbox class="select-member"
                          :disabled="cardStatus === 'cancel'"
                          v-model="selectMember" @on-change="chooseMember" />
            </div>

            <div class="property-list small-block-narrow">
                <div class="property-cell">
                    <div class="property-name">成长值</div>
                    <div class="property-value">{{ memberInfo.growthBalance }}</div>
                </div>
    ...
    <!--                </div>-->
                ...
                <div v-if="hasVipLevel && levelStatus" class="separation-line"></div>
                <div  v-if="hasVipLevel && levelStatus">
                    <div class="property-name">
                        <span>等级</span>
                        <i v-if="memberInfo.isFrozenLevel" class="icon iconfont iconLocked" title="保级" ></i>
                    </div>
...
<!--        </div>-->
            ...
            <div class="btn-container big-block-narrow" v-if="cardStatus !== 'cancel'">
                <span @click="jumpDetail" class="card-action">详情</span>
                <span @click="markMember" class="card-action">打标签</span>
                <span  @click="showAccountAction" class="card-action"  >
                    <i class="icon iconfont iconMore" title="更多" ></i>
                </span>
            </div>
            <div class="btn-container big-block-narrow cancel-card" v-else>
                <span class="cancel-member">已注销</span>
            </div>

            <ul class="account-list" v-if="accountAction &&(cardStatus !== 'cancel')">
            ...
            <div @click="showAccountAction" class="action-background" v-if="accountAction &&(cardStatus !== 'cancel')">
            </div>
