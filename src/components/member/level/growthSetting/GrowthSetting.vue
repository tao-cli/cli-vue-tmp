                ...
                <i-col span="8" class="left-col">
                    <div class="preview-container">
                        ...
                        <div class="level-desc">
                            <div class="desc-detail" v-html="growthForm.description"></div>
                        </div>
                    </div>
                </i-col>

                <i-col span="16" class="right-col">
                    <Form ref="memberInfo"  :label-width="150" :model="growthForm"
...
<!--                        </FormItem>-->
                        ...
                        <FormItem label="成长值有效期：" prop="growthExpirationYear" class="middle-block-narrow">
                            <div class="input-container">
                                <i-input v-model="growthForm.growthExpirationYear"
                        ...
                        <div v-if="growthForm.open">
                            <FormItem label="兑换比例：" prop="consumeMoney" class="middle-block-narrow">
                                <div class="input-container">
                                    <span>每消费</span>
                                    <i-input v-model="growthForm.consumeMoney"
                                ...
                                <RadioGroup v-model="limitType">
                                    ...
                                    <div v-else class="max-growth">
                                        <Radio  label="2">
                                            ...
                                            <i-input v-model="growthForm.maxLimit"
